...
El resto de parámetros ingresados son por defecto de la cámara, estos tienen desactivado el test de colores de la cámara mas este se puede configurar con el COM17 ingresando el número 42 y agregando el parametro  SCALING_XSC con el número 70 para lineas horizontales y SCALING_YSC con el número 71 para lineas verticales, 
